...
export interface ILogsClient {
    ...
    /**
     * @generated from protobuf rpc: GetLogs(logs.LogRequest) returns (logs.LogReply);
     */
    getLogs(input: LogRequest, options?: RpcOptions): UnaryCall<LogRequest, LogReply>;
}
/**
 * @generated from protobuf service logs.Logs
 */
export class LogsClient implements ILogsClient, ServiceInfo {
    ...
    getLogs(input: LogRequest, options?: RpcOptions): UnaryCall<LogRequest, LogReply> {
        ...
        return stackIntercept<LogRequest, LogReply>("unary", this._transport, method, opt, input);
    }
}
